...
- [ ] PR name uses present imperative tense and specifically describes the changes
  ...
  - Correct: ✅ Update version of react-dnd
...
- [ ] My pull request does not make any changes in `versions.json` file.
- [ ] My pull request does not changes the version of this library in `package.json` file.
- [ ] `package-lock.json` file is up-to-date with `package.json` file.
